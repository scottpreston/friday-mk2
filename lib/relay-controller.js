...
RelayController.prototype.closeSuit = function () {
    relayWrite(leftLeg, relayDown);
    relayWrite(rightLeg, relayDown);
}

RelayController.prototype.init = function (callBack) {
    var count = 0;
    var setUp = function () {
        count++;
        if (count == 8) callBack();
    ...
    gpio.setup(16, gpio.DIR_OUT, setUp);

    gpio.setup(18, gpio.DIR_OUT, setUp);
    gpio.setup(22, gpio.DIR_OUT, setUp);

    gpio.setup(24, gpio.DIR_OUT, setUp);
    gpio.setup(26, gpio.DIR_OUT, setUp);
